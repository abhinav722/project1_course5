...
2. Mean and median of "total number of step taken per day" over all days
-------------------------------------------------------------
...
Then we can find the mean and median of 'total number of steps per day'. (desplayed in the summary table)
